...
def evaluate(delta_floor, min_area, merge_radius, edge_k, left_margin_x, mask_crack_ledge):
...
configs = [
    # (delta_floor, min_area, merge_radius, edge_k, left_margin_x, mask_crack_ledge)
    (12.0, 30, 55, 5, 0, False),
    (12.0, 30, 55, 5, 48, False),
    (12.0, 30, 55, 5, 48, True),
    (10.0, 30, 55, 5, 48, True),
    (8.0, 30, 55, 5, 48, True),
    (8.0, 20, 55, 5, 48, True),
]

for df, ma, mr, ek, lmx, mcl in configs:
    matched, fp_count, fps, missed, total = evaluate(df, ma, mr, ek, lmx, mcl)
    print(f"\ndf={df}, ma={ma}, mr={mr}, ek={ek}, lmx={lmx}, mcl={mcl}")
