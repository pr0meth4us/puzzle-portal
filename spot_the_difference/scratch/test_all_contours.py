...
canvas.save("/Users/nicksng/code/puzzle-portal/spot_the_difference/results/res_puzzle_07_all_contours.png", quality=95)
print("Saved all contours result to results/res_puzzle_07_all_contours.png")
