...
img = cv2.imread("results/res_puzzle_07_all_contours.png")
h, w = img.shape[:2]

os.makedirs("/Users/nicksng/.gemini/antigravity-ide/brain/a9d592a8-47fc-46e0-97b5-25fed2b74e19/artifacts/all_contours_crops", exist_ok=True)
...
for idx, (cx, cy, r) in enumerate(circles):
    ...
    cv2.imwrite(f"/Users/nicksng/.gemini/antigravity-ide/brain/a9d592a8-47fc-46e0-97b5-25fed2b74e19/artifacts/all_contours_crops/diff_{idx+1}.png", crop)
